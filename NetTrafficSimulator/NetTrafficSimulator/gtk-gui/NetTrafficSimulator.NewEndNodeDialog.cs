...
{
	public partial class NewEndNodeDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget NetTrafficSimulator.NewEndNodeDialog
			this.Name = "NetTrafficSimulator.NewEndNodeDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child NetTrafficSimulator.NewEndNodeDialog.VBox
			...
			this.label1.LabelProp = global::Mono.Unix.Catalog.GetString ("Add new end node");
			...
			w7.Expand = false;
			w7.Fill = false;
			// Internal child NetTrafficSimulator.NewEndNodeDialog.ActionArea
